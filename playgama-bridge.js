    ...
    r.n = e => {
        ...
        const N = function() {
            function e(t) {
                ...
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), r = this, o = void 0, (n = j(n = "_platformBridge")) in r ? Object.defineProperty(r, n, {
                    value: o,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
        ...
        const x = function(e) {
            ...
            function a() {
                ...
                return t = F(e = i.call.apply(i, [this].concat(s))), n = {
                        writable: !0,
                        value: !1
                    },
                    function(e, t) {
        ...
        const J = function(e) {
            ...
            return t = a, (r = [{
                ...
                key: "getPayingStatus",
                get: function() {
                    return this._platformBridge.getPayingPlayerStatus
                }
            }, {
                key: "name",
                get: function() {
		...
		function GetStatus(){
			if (this._platformBridge.platformId !== 'yandex'){
				return Promise.resolve(0);
			}
			const str = this._platformBridge.getPayingStatus();
        // преобразуем в число
        const map = {
            unknown:           0,
            paying:            1,
        ...
        return Promise.resolve(map[str] ?? 0);
        ...
        function $(e, t) {
            for (var r = 0; r < t.length; r++) {
                var n = t[r];
                n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, ee(n.key), n)
            }
        }
        ...
        const le = function(e) {
            ...
            return t = a, r = [{
                ...
                value: function(e, t) {
                    ...
                    var o = t;
                    return o || (o = this.defaultType), this._platformBridge.isStorageAvailable(o) ? this._platformBridge.getDataFromStorage(e, o, r) : Promise.reject()
                }
            }, {
                key: "set",
                value: function(e, t, r) {
                    ...
                    var o = r;
                    return o || (o = this.defaultType), this._platformBridge.isStorageAvailable(o) ? this._platformBridge.setDataToStorage(e, t, o) : Promise.reject()
                }
            }, {
                key: "delete",
                value: function(e, t) {
                    ...
                    var n = t;
                    return n || (n = this.defaultType), this._platformBridge.isStorageAvailable(n) ? this._platformBridge.deleteDataFromStorage(e, n) : Promise.reject()
                }
        ...
        var be = "created",
            ...
            Ie = function() {
                ...
                return t = e, (r = [{
                    ...
                    value: function() {
                        var e = this;
                        ge(this, we) !== be && ge(this, we) !== Pe || (_e(this, Ae, ge(this, Ee)), ve(this, De, Re).call(this, "started"), _e(this, Oe, setInterval((function() {
                ...
                return t = l, (r = [{
                    ...
                    value: function(e) {
                        ...
                        switch (r) {
                            case "number":
                                ...
                                break;
                            case "string":
                                if (n = parseInt(e, 10), Number.isNaN(n)) return;
                                break;
                            default:
                                return
                        }
                    ...
                    value: function(e) {
                        if (!xe(this, Je, Qe).call(this)) {
                            ...
                            var r = !1;
                            e && "boolean" == typeof e.ignoreDelay && (r = e.ignoreDelay), this._platformBridge._setInterstitialState(i.LOADING), !We(this, Ye) || We(this, Ye).state === Pe || r ? this._platformBridge.showInterstitial(e) : this._platformBridge._setInterstitialState(i.FAILED)
                        }
                    }
                }, {
                    key: "showRewarded",
            ...
            qt = function() {
                function t(e) {
                    ...
                    ! function(e, t) {
                        ...
                        function(e, t) {
                            if (t.has(e)) throw new TypeError("Cannot initialize the same private elements twice on an object")
                        }(r = this, n = Jt), n.set(r, i);
                    try {
                        this._localStorage = window.localStorage
                    } catch (e) {}
                    this._visibilityState = document.visibilityState, document.addEventListener("visibilitychange", (function() {
                    ...
                    value: function(e, t, r) {
                        if (t === u.LOCAL_STORAGE) {
                            if (this._localStorage) {
                                if (Array.isArray(e)) {
                                    for (var n = [], o = 0; o < e.length; o++) n.push(this._getDataFromLocalStorage(e[o], r));
                ...
                }]) && Vt(r.prototype, l), Object.defineProperty(r, "prototype", {
                    writable: !1
                }), t
            }();
        ...
        const vr = function(t) {
            ...
            function d() {
                ...
                return lr(t = ur(e = p.call.apply(p, [this].concat(o))), r = hr), r.add(t),
                    function(e, t, r) {
                        lr(e, t), t.set(e, {
                            writable: !0,
                            value: void 0
            ...
            return r = d, (n = [{
                ...
                value: function() {
                    ...
                    if (!o) {
                        ...
                        i.searchParams.has("platform") && (t = this, r = yr, n = i.searchParams.get("platform"), function(e, t, r) {
                            if (t.set) t.set.call(e, r);
                            else {
                                if (!t.writable) throw new TypeError("attempted to set read only private field");
                                t.value = r
                ...
                value: function(e) {
                    ...
                    var t = e.groupId;
                    return "string" == typeof t && (t = parseInt(t, 10), Number.isNaN(t)) ? Promise.reject() : fr(this, hr, mr).call(this, f.JOIN_COMMUNITY, "VKWebAppJoinGroup", {
                        group_id: t
                    }).then((function() {
                ...
                value: function(e) {
                    var t = {};
                    return e && e.link && (t.link = e.link), fr(this, hr, mr).call(this, f.SHARE, "VKWebAppShare", t, "type")
                }
            }, {
                key: "addToHomeScreen",
                value: function() {
                ...
                value: function(e) {
                    ...
                    return "boolean" == typeof e.global && (t.global = e.global ? 1 : 0), fr(this, hr, mr).call(this, f.SHOW_LEADERBOARD_NATIVE_POPUP, "VKWebAppShowLeaderBoardBox", t)
                }
            }, {
                key: "clipboardWrite",
                value: function(e) {
            ...
            }]) && or(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), d
        }(Xt);
        ...
        function Sr(e) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                t % 2 ? gr(Object(r), !0).forEach((function(t) {
                    var n, o, i;
                    n = e, o = t, i = r[t], (o = Pr(o)) in n ? Object.defineProperty(n, o, {
                        value: i,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        function br(e, t) {
            for (var r = 0; r < t.length; r++) {
                var n = t[r];
                n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, Pr(n.key), n)
            }
        }
            ...
            return new Promise((function(r) {
                ...
                e && "boolean" == typeof e.scopes && (n.scopes = e.scopes), t._platformSdk.getPlayer(n).then((function(e) {
                    ...
                    var n = e.getPhoto("small"),
                        o = e.getPhoto("medium"),
                        i = e.getPhoto("large");
                    return n && t._playerPhotos.push(n), o && t._playerPhotos.push(o), i && t._playerPhotos.push(i), Ir(t, Nr, e), e.getData()
                })).then((function(e) {
        ...
        const Fr = function(t) {
            ...
            function y() {
                ...
                for (var n = arguments.length, o = new Array(n), i = 0; i < n; i++) o[i] = arguments[i];
                return kr(t = wr(e = d.call.apply(d, [this].concat(o))), r = Gr), r.add(t), Dr(wr(e), jr, {
                    writable: !0,
                    value: !1
                }), Dr(wr(e), Nr, {
                    writable: !0,
            ...
            return r = y, (n = [{
                ...
                value: function() {
                    ...
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("/sdk.js").then((function() {
                ...
                value: function(e) {
                    switch (e) {
                        ...
                        case l.GAMEPLAY_STOPPED:
                            var n;
                            return null === (n = this._platformSdk.features.GameplayAPI) || void 0 === n || n.stop(), Promise.resolve();
                        default:
                ...
                value: function(e) {
                    ...
                    return r || (r = this._createPromiseDecorator(f.AUTHORIZE_PLAYER), this._isPlayerAuthorized ? Rr(this, Gr, Mr).call(this, e).then((function() {
                ...
                value: function(e) {
                    ...
                    if (!(Tr(this, Cr) && e && e.score && e.leaderboardName)) return Promise.reject();
                    var r = this._getPromiseDecorator(f.SET_LEADERBOARD_SCORE);
                    return r || (r = this._createPromiseDecorator(f.SET_LEADERBOARD_SCORE), Tr(this, Cr).setLeaderboardScore(e.leaderboardName, "string" == typeof e.score ? parseInt(e.score, 10) : e.score).then((function() {
                ...
                value: function(e) {
                    var t = this;
                    if (!this._isPlayerAuthorized) return Promise.reject();
                    if (!Tr(this, Cr) || !e || !e.leaderboardName) return Promise.reject();
                    var r = this._getPromiseDecorator(f.GET_LEADERBOARD_SCORE);
                    return r || (r = this._createPromiseDecorator(f.GET_LEADERBOARD_SCORE), Tr(this, Cr).getLeaderboardPlayerEntry(e.leaderboardName).then((function(e) {
                ...
                value: function(e) {
                    ...
                    if (!r) {
                        ...
                        var n = {};
                        n.includeUser = "boolean" == typeof e.includeUser && e.includeUser, n.quantityAround = "string" == typeof e.quantityAround ? parseInt(e.quantityAround, 10) : e.quantityAround, Number.isNaN(n.quantityAround) && (n.quantityAround = 5), n.quantityTop = "string" == typeof e.quantityTop ? parseInt(e.quantityTop, 10) : e.quantityTop, Number.isNaN(n.quantityTop) && (n.quantityTop = 5), Tr(this, Cr).getLeaderboardEntries(e.leaderboardName, n).then((function(e) {
                            var r = null;
                ...
                value: function(e) {
                    ...
                    if (!Tr(this, Br) || !r) return Promise.reject();
                    var n = this._getPromiseDecorator(f.PURCHASE);
                    return n || (n = this._createPromiseDecorator(f.PURCHASE), Tr(this, Br).purchase(r).then((function(r) {
                        var n = Sr({
                            commonId: e
                        }, r.purchaseData);
                        t._paymentsPurchases.push(n), t._resolvePromiseDecorator(f.PURCHASE, n)
                    })).catch((function(e) {
                ...
                value: function(e) {
                    var t = this;
                    if (!Tr(this, Br)) return Promise.reject();
                    ...
                    return n || (n = this._createPromiseDecorator(f.CONSUME_PURCHASE), Tr(this, Br).consumePurchase(this._paymentsPurchases[r].purchaseToken).then((function(e) {
                ...
                value: function() {
                    ...
                    return r || (r = this._createPromiseDecorator(f.GET_CATALOG), Tr(this, Br).getCatalog().then((function(r) {
                ...
                value: function() {
                    ...
                    return t || (t = this._createPromiseDecorator(f.GET_PURCHASES), Tr(this, Br).getPurchases().then((function(t) {
                ...
                value: function(e) {
                    ...
                    return n || (n = this._createPromiseDecorator(f.GET_REMOTE_CONFIG), this._platformSdk.getFlags(r).then((function(e) {
            ...
            }]) && br(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), y
        }(Xt);
        ...
        const an = function(t) {
            ...
            function y() {
                ...
                return Kr(t = Vr(e = d.call.apply(d, [this].concat(o))), r = nn), r.add(t), Zr(Vr(e), en, {
                    writable: !0,
                    value: !1
                }), Zr(Vr(e), tn, {
                    writable: !0,
            ...
            return r = y, (n = [{
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://sdk.crazygames.com/crazygames-sdk-v3.js").then((function() {
                ...
                value: function() {
                    var e = this;
                    if (!Xr(this, tn)) return Promise.reject();
                    ...
                    return r === u.PLATFORM_INTERNAL ? new Promise((function(r) {
                        if (Array.isArray(e)) {
                            for (var o = 0; o < e.length; o++) {
                                var i = t[o];
                                "string" != typeof t[o] && (i = JSON.stringify(t[o])), n._platformSdk.data.setItem(e[o], i)
                            }
                            r()
                        } else {
                            var a = t;
                            "string" != typeof t && (a = JSON.stringify(t)), n._platformSdk.data.setItem(e, a), r()
                        }
                ...
                value: function(e, t) {
                    ...
                    })), Promise.resolve()) : (this._platformSdk.data.removeItem(e), Promise.resolve()) : xr(Yr(y.prototype), "deleteDataFromStorage", this).call(this, e, t)
                }
            }, {
                key: "showBanner",
                value: function(e) {
                    ...
                    r || ((r = document.createElement("div")).id = $r, r.style.position = "absolute", document.body.appendChild(r)), "top" === (null == e ? void 0 : e.position) ? (r.style.top = 0, r.style.height = "90px", r.style.width = "100%") : "left" === (null == e ? void 0 : e.position) ? (r.style.left = 0, r.style.top = 0, r.style.height = "100%", r.style.width = "90px") : "right" === (null == e ? void 0 : e.position) ? (r.style.right = 0, r.style.top = 0, r.style.height = "100%", r.style.width = "90px") : (r.style.bottom = 0, r.style.height = "90px", r.style.width = "100%"), r.style.display = "block", this._platformSdk.banner.requestResponsiveBanner([$r]).then((function() {
            ...
            }]) && Ur(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), y
        }(Xt);
        ...
        function cn(e) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                t % 2 ? un(Object(r), !0).forEach((function(t) {
                    var n, o, i;
                    n = e, o = t, i = r[t], (o = fn(o)) in n ? Object.defineProperty(n, o, {
                        value: i,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        function vn() {
            ...
            return this._playerId = this._platformSdk.options.player_id, this._isPlayerAuthorized = "false" === this._platformSdk.options.guest, new Promise((function(t) {
                e._platformSdk.getUsers([e._playerId], (function(r) {
                    if (r && 1 === r.length) {
                        var n = r[0];
                        e._playerName = n.full_name, "" !== n.avatar && (e._playerPhotos = [n.avatar])
                    }
                    t()
                }))
            }))
        ...
        const _n = function(t) {
            ...
            return r = l, (n = [{
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://unpkg.com/@agru/sdk/dist/umd/index.min.js").then((function() {
                ...
                value: function(e, t, r) {
                    ...
                    return t === u.PLATFORM_INTERNAL ? new Promise((function(t, r) {
                        ...
                        } else n._isPlayerAuthorized ? n._platformSdk.getSaveData((function(o, i) {
                            if (null === i) {
            ...
            }]) && ln(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), l
        }(Xt);
        ...
        const Rn = function(t) {
            ...
            function p() {
                ...
                return t = En(e = l.call.apply(l, [this].concat(i))), n = {
                        writable: !0,
                        value: !1
                    },
                    function(e, t) {
            ...
            return r = p, (n = [{
                ...
                value: function(e) {
                    ...
                    r || ((r = document.createElement("div")).id = kn, r.style.position = "absolute", document.body.appendChild(r)), "top" === (null == e ? void 0 : e.position) ? (r.style.top = 0, r.style.height = "90px", r.style.width = "100%") : "left" === (null == e ? void 0 : e.position) ? (r.style.left = 0, r.style.top = 0, r.style.height = "100%", r.style.minHeight = "600px", r.style.width = "120px") : "right" === (null == e ? void 0 : e.position) ? (r.style.right = 0, r.style.top = 0, r.style.height = "100%", r.style.minHeight = "600px", r.style.width = "120px") : (r.style.bottom = 0, r.style.height = "90px", r.style.width = "100%"), r.style.display = "block", this._platformSdk.showAd("display", {
                        containerId: kn
                    }).then((function() {
                        t._setBannerState(s.SHOWN)
                    })).catch((function() {
                ...
                value: function() {
                    var e = this;
                    wn(this, In, !1), this._platformSdk ? this._platformSdk.showAd().catch((function() {
                        e._setInterstitialState(i.FAILED)
                    })) : this._setInterstitialState(i.FAILED)
                }
            }, {
                ...
                value: function() {
                    var e = this;
                    wn(this, In, !0), this._platformSdk ? this._platformSdk.showAd("rewarded").catch((function() {
                        e._setRewardedState(a.FAILED)
                    })) : this._setRewardedState(a.FAILED)
                }
            }]) && Sn(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), p
        }(Xt);
        ...
        function vo(e, t) {
            "ok" === e && (this._playerId = t.uid, this._playerName = t.name, this._playerPhotos = [t.pic50x50, t.pic128x128, t.pic_base]), this._isInitialized = !0, this._platformSdk.Client.call(Vn(this, Kn).hasAppPermission(Zn.VALUABLE_ACCESS), Vn(this, Jn).hasValueAccessCallback)
        }
        ...
        const jo = function(t) {
            ...
            function l() {
                ...
                return Fn(Gn(e = c.call.apply(c, [this].concat(r))), po), Fn(Gn(e), fo), Fn(Gn(e), lo), Fn(Gn(e), co), Fn(Gn(e), uo), Fn(Gn(e), so), Fn(Gn(e), ao), Fn(Gn(e), io), Fn(Gn(e), oo), Fn(Gn(e), no), Fn(Gn(e), ro), Fn(Gn(e), to), Fn(Gn(e), eo), Fn(Gn(e), $n), Fn(Gn(e), Qn), Fn(Gn(e), Xn), Hn(Gn(e), qn, {
                    get: mo,
                    set: void 0
                }), Hn(Gn(e), Jn, {
                    get: ho,
            ...
            return r = l, (n = [{
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("//api.ok.ru/js/fapi5.js").then((function() {
                        $t("FAPI").then((function() {
                            ...
                            t.api_server && t.apiconnection ? e._platformSdk.init(t.api_server, t.apiconnection, (function() {
                                ...
                                e._isPlayerAuthorized = !r || r === Yn, e._isPlayerAuthorized ? e._platformSdk.Client.call(Vn(e, Kn).userProfile, Vn(e, Jn).userProfileCallback) : (e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE))
                            }), (function() {
                ...
                value: function() {
                    ...
                    return e || (e = this._createPromiseDecorator(f.AUTHORIZE_PLAYER), this._platformSdk.UI.showLoginSuggestion(Yn)), e.promise
                }
            }, {
                key: "isStorageSupported",
                value: function(e) {
                ...
                value: function(e) {
                    if (e) {
                        if ("string" == typeof e.layoutType) return this._platformBannerOptions = jn(jn({}, e), {}, {
                            layoutType: null
            ...
            }]) && Nn(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), l
        }(Xt);
        ...
        function Co() {
            ...
            function D(t, r) {
                var n = r.method,
                    o = t.iterator[n];
                if (o === e) return r.delegate = null, "throw" === n && t.iterator.return && (r.method = "return", r.arg = e, D(t, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), m;
        ...
        function Mo(e) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                t % 2 ? Go(Object(r), !0).forEach((function(t) {
                    var n, o, i;
                    n = e, o = t, i = r[t], (o = Ho(o)) in n ? Object.defineProperty(n, o, {
                        value: i,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            return e = Co().mark((function e(t) {
                ...
                return Co().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (r = n.length > 1 && void 0 !== n[1] && n[1], this._platformStorageCachedData) {
                                e.next = 5;
                                break
                            }
                            return e.next = 4, this.platformSdk.cloudSaveApi.getState();
                        case 4:
        ...
        const Qo = function(t) {
            ...
            function l() {
                ...
                for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                return Vo(xo(e = c.call.apply(c, [this].concat(r))), Ko), Vo(xo(e), Zo), e
            }
            return r = l, (n = [{
                key: "platformId",
                get: function() {
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://developer.playgama.com/sdk/v1.js").then((function() {
                ...
                value: function(e, t, r) {
                    ...
                    switch (r) {
                        ...
                        case u.LOCAL_STORAGE:
                            var o = {};
                            if (Array.isArray(e))
                                for (var i = 0; i < e.length; i++) o[e[i]] = "string" != typeof t[i] ? JSON.stringify(t[i]) : t[i];
                            else o[e] = "string" != typeof t ? JSON.stringify(t) : t;
                            return this._platformSdk.storageApi.setItems(o), Uo(Wo(l.prototype), "setDataToStorage", this).call(this, e, t, r);
                        default:
                            return Promise.reject(d)
                    }
                }
                ...
                value: function(e, t) {
                    ...
                    switch (t) {
                        ...
                        case u.LOCAL_STORAGE:
                            return this._platformSdk.storageApi.deleteItems(Array.isArray(e) ? e : [e]), Uo(Wo(l.prototype), "deleteDataFromStorage", this).call(this, e, t);
                        default:
                            return Promise.reject(d)
                    }
                }
                ...
                value: function(e) {
                    var t = this,
                        r = this._getPromiseDecorator(f.AUTHORIZE_PLAYER);
                    return r || (r = this._createPromiseDecorator(f.AUTHORIZE_PLAYER), this._isPlayerAuthorized ? Yo(this, Zo, Jo).call(this, e).then((function() {
                        t._resolvePromiseDecorator(f.AUTHORIZE_PLAYER)
                ...
                value: function(e) {
                    ...
                    var n = this._getPromiseDecorator(f.PURCHASE);
                    return n || (n = this._createPromiseDecorator(f.PURCHASE), this._platformSdk.inGamePaymentsApi.purchase(r).then((function(r) {
                        if ("PAID" === r.status) {
                            var n = Mo({
                                commonId: e
                            }, r);
            ...
            }]) && Fo(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), l
        }(Xt);
        ...
        const yi = function(t) {
            ...
            return r = p, n = [{
                    ...
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), window.addEventListener("message", (function t(r) {
                        ...
                        if (n && n.playdeck) {
                            ...
                            if ("getUserProfile" === o.method) {
                                var i = o.value;
                                e._playerId = i.telegramId, e._playerPhotos = [i.avatar], e._playerName = i.username, ci(e, pi, i.locale), ci(e, di, i.params), window.removeEventListener("message", t), e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE)
                            }
                        }
                    ...
                    return t === u.PLATFORM_INTERNAL ? new Promise((function(t) {
                        ...
                        window.addEventListener("message", (function o(i) {
                            ...
                            if (a && a.playdeck && "getData" === a.playdeck.method && n.includes(a.playdeck.key)) {
                                var s = a.playdeck;
                                if ("getData" === s.method && (r[s.key] = s.value.data), Object.keys(r).length === n.length) {
                ...
                value: function(e) {
                    ...
                    r.externalId || (r.externalId = this._paymentsGenerateTransactionId(e));
                    var n = this._getPromiseDecorator(f.PURCHASE);
                    return n || (n = this._createPromiseDecorator(f.PURCHASE), window.addEventListener("message", (function e(t) {
                        var r = t.data,
                        ...
                        if (i && "invoiceClosed" === i.method)
                            if ("paid" === i.value.status) {
                                ...
                                t._paymentsPurchases.push(a), t._resolvePromiseDecorator(f.PURCHASE, a)
            ...
            }], n && ti(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), p
        }(Xt);
        ...
        function vi(e) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                t % 2 ? mi(Object(r), !0).forEach((function(t) {
                    var n, o, i;
                    n = e, o = t, i = r[t], (o = gi(o)) in n ? Object.defineProperty(n, o, {
                        value: i,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        const Ri = function(t) {
            ...
            function d() {
                ...
                for (var n = arguments.length, o = new Array(n), i = 0; i < n; i++) o[i] = arguments[i];
                return Ai(t = Pi(e = p.call.apply(p, [this].concat(o))), r = ki), r.add(t),
                    function(e, t, r) {
                        Ai(e, t), t.set(e, {
                            writable: !0,
                            value: void 0
            ...
            return r = d, (n = [{
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://storage.googleapis.com/cdn-wortal-ai/v2/wortal-core.js").then((function() {
                        $t("Wortal", "initializeAsync").then((function() {
                            window.Wortal.initializeAsync().then((function() {
                                var t, r, n;
                                e._platformSdk = window.Wortal, t = e, r = Di, n = e._platformSdk.getSupportedAPIs(),
                                    function(e, t, r) {
                                        if (t.set) t.set.call(e, r);
                                        else {
                                            if (!t.writable) throw new TypeError("attempted to set read only private field");
                ...
                value: function(e) {
                    var t = this,
                        r = "next",
                        n = "NextLevel";
                    e && (e.placement && (r = e.placement), e.description && (n = e.description)), this._platformSdk.ads.showInterstitial(r, n, (function() {
                        ...
                        n._platformSdk.player.getDataAsync(o).then((function(r) {
                            if (n._platformStorageCachedData || (n._platformStorageCachedData = {}), Array.isArray(e)) {
                                for (var o = [], i = 0; i < e.length; i++) {
                                    ...
                                    o.push(a), n._platformStorageCachedData[e[i]] = a
                                }
                                t(o)
                            } else {
                                var s = void 0 === r[e] ? null : r[e];
                                n._platformStorageCachedData[e] = s, t(s)
                            }
                        })).catch((function(e) {
                            return r(e)
                        }))
            ...
            }]) && _i(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), d
        }(Xt);
        ...
        const Zi = function(t) {
            ...
            function d() {
                ...
                for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                return Mi(Ci(e = p.call.apply(p, [this].concat(r))), "_defaultStorageType", u.PLATFORM_INTERNAL), Mi(Ci(e), "_isPlayerAuthorized", !0), Gi(Ci(e), xi, {
                    writable: !0,
                    value: void 0
                }), Gi(Ci(e), Wi, {
                    writable: !0,
            ...
            return r = d, (n = [{
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://telegram.org/js/telegram-web-app.js").then((function() {
                        e._platformSdk = window.Telegram.WebApp;
                        var t = e._platformSdk.initDataUnsafe.user;
                        e._playerId = t.id, e._playerName = [t.first_name, t.last_name].filter(Boolean).join(" "), e._playerPhotos = [t.photo_url], Hi(e, xi, e._platformSdk.platform), e._isInitialized = !0, e._options && e._options.adsgramBlockId ? Qt("https://sad.adsgram.ai/js/sad.min.js").then((function() {
                ...
                value: function() {
                    var e = this;
                    Ui(this, Wi) ? (Ui(this, Wi).addEventListener("onStart", Ui(this, Yi).onStart), Ui(this, Wi).addEventListener("onSkip", Ui(this, Yi).onSkip), Ui(this, Wi).addEventListener("onError", Ui(this, Yi).onError), Ui(this, Wi).addEventListener("onBannerNotFound", Ui(this, Yi).onError), Ui(this, Wi).show().finally((function() {
                ...
                value: function() {
                    var e = this;
                    Ui(this, Wi) ? (Ui(this, Wi).addEventListener("onStart", Ui(this, Vi).onStart), Ui(this, Wi).addEventListener("onSkip", Ui(this, Vi).onSkip), Ui(this, Wi).addEventListener("onReward", Ui(this, Vi).onReward), Ui(this, Wi).addEventListener("onError", Ui(this, Vi).onError), Ui(this, Wi).addEventListener("onBannerNotFound", Ui(this, Vi).onError), Ui(this, Wi).show().finally((function() {
            ...
            }]) && Li(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), d
        }(Xt);
        var Ki = ["player"];
        ...
        function fa(e) {
            if ("ok" === e.status) {
                ...
                var t = e.authResponse.details,
                    ...
                    a = t.last_name,
                    s = t.avatars;
                r && (this._playerId = r), this._platformLanguage = n, this._playerName = [i, a].filter((function(e) {
                    return !!e
                })).join(" ") || o, this._playerPhotos = [];
                var c = s.thumb_url,
                    l = s.medium_url,
                    f = s.large_url;
        ...
        const pa = function(t) {
            ...
            var r, n, o, s, c = (o = l, s = function() {
                ...
                return function(e, t) {
                    if (t && ("object" === Xi(t) || "function" == typeof t)) return t;
                    if (void 0 !== t) throw new TypeError("Derived constructors may only return object or undefined");
                    return ra(e)
                }(this, e)
            });
            ...
            function l() {
                ...
                for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                return oa(ra(e = c.call.apply(c, [this].concat(r))), ca), oa(ra(e), ua), e
            }
            return r = l, (n = [{
                key: "platformId",
                get: function() {
                ...
                value: function() {
                    ...
                    return r || (r = this._createPromiseDecorator(f.INITIALIZE), null !== (t = this._options) && void 0 !== t && t.gameId ? Qt("https://cdn.y8.com/api/sdk.js").then((function() {
                        $t("ID").then((function() {
                            e._platformSdk = window.ID, e._platformSdk.Event.subscribe("id.init", (function() {
                                ...
                                (t = {
                                    ...
                                    t.setAttribute("data-ad-client", n), o ? t.setAttribute("data-ad-channel", o) : r && t.setAttribute("data-ad-host", r), t.setAttribute("data-ad-frequency-hint", a), t.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js", t.addEventListener("load", e), document.head.appendChild(t)
                                }))).then((function() {
                ...
                value: function(e) {
                    ...
                    var r = this._getPromiseDecorator(f.GET_LEADERBOARD_SCORE);
                    return r || (r = this._createPromiseDecorator(f.GET_LEADERBOARD_SCORE), this._platformSdk.GameAPI.Leaderboards.listCustom(qi(qi({}, e), {}, {
            ...
            }]) && Qi(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), l
        }(Xt);
        ...
        const ga = function(t) {
            ...
            var r, n, o, s, c = (o = l, s = function() {
                ...
                return function(e, t) {
                    if (t && ("object" === da(t) || "function" == typeof t)) return t;
                    if (void 0 !== t) throw new TypeError("Derived constructors may only return object or undefined");
                    return function(e) {
                        if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                        return e
            ...
            return r = l, (n = [{
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), this._options && this._options.devId && this._options.publisherId ? Qt("https://lagged.com/api/rev-share/lagged.js").then((function() {
                        $t("LaggedAPI").then((function() {
                            e._platformSdk = window.LaggedAPI, e._platformSdk.init(e._options.devId, e._options.publisherId), e._platformSdk.User.get((function(t) {
                                var r, n = null !== (r = null == t ? void 0 : t.user) && void 0 !== r ? r : {},
                                    o = n.id,
                                    i = n.name,
                                    a = n.avatar;
                                o > 0 && (e._playerId = o, e._playerName = i, e._playerPhotos.push(a), e._isPlayerAuthorized = !0), e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE)
                            }))
                        }))
            ...
            }]) && ya(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), l
        }(Xt);
        ...
        function Na(e) {
            var t = this;
            if (!(arguments.length > 1 && void 0 !== arguments[1] && arguments[1]) && this._preloadedInterstitialPromises[e]) return this._preloadedInterstitialPromises[e];
            var r = null;
        ...
        function Ca(e) {
            var t = this;
            if (!(arguments.length > 1 && void 0 !== arguments[1] && arguments[1]) && this._preloadedRewardedPromises[e]) return this._preloadedRewardedPromises[e];
            var r = null;
        ...
        const Ba = function(t) {
            ...
            function y() {
                ...
                for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                return ka(Oa(e = d.call.apply(d, [this].concat(r))), ja), ka(Oa(e), La), Ia(Oa(e), "_contextId", null), Ia(Oa(e), "_bannerPlacementId", null), Ia(Oa(e), "_interstitialPlacements", []), Ia(Oa(e), "_rewardedPlacements", []), Ia(Oa(e), "_isPlayerAuthorized", !0), Ia(Oa(e), "_supportedApis", []), Ia(Oa(e), "_preloadedInterstitialPromises", {}), Ia(Oa(e), "_preloadedRewardedPromises", {}), Ia(Oa(e), "_defaultStorageType", u.PLATFORM_INTERNAL), e
            }
            return r = y, n = [{
                key: "platformId",
                get: function() {
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://connect.facebook.net/en_US/fbinstant.8.0.js").then((function() {
                        return $t("FBInstant")
                    })).then((function() {
                        return e._platformSdk = window.FBInstant, e._platformSdk.initializeAsync()
                    })).then((function() {
                        e._bannerPlacementId = e._options.bannerPlacementId || null, e._interstitialPlacements = e._options.interstitialPlacements || [], e._rewardedPlacements = e._options.rewardedPlacements || [], e._playerId = e._platformSdk.player.getID(), e._contextId = e._platformSdk.context.getID();
                        var t = e._platformSdk.getLocale();
                        t && t.length > 2 && (e._platformLanguage = t.substring(0, 2).toLowerCase()), e._supportedApis = e._platformSdk.getSupportedAPIs(), e._isInitialized = !0;
                ...
                value: function(e) {
                    var t, r = this,
                        n = e || (null === (t = this._interstitialPlacements[0]) || void 0 === t ? void 0 : t.id);
                ...
                value: function(e) {
                    var t, r = this,
                        n = e || (null === (t = this._rewardedPlacements[0]) || void 0 === t ? void 0 : t.id);
                ...
                value: function(e) {
                    ...
                    if (!r) return Promise.reject();
                    var n = this._getPromiseDecorator(f.PURCHASE);
                    return n || (n = this._createPromiseDecorator(f.PURCHASE), this._platformSdk.payments.purchaseAsync(r).then((function(r) {
                        var n = ba({
                            commonId: e
                        }, r);
                        t._paymentsPurchases.push(n), t._resolvePromiseDecorator(f.PURCHASE, r)
                    })).catch((function(e) {
                        t._rejectPromiseDecorator(f.PURCHASE, e)
                    }))), n.promise
                }
                ...
                value: function(e) {
                    ...
                    if (r < 0) return Promise.reject();
                    var n = this._getPromiseDecorator(f.CONSUME_PURCHASE);
                    return n || (n = this._createPromiseDecorator(f.CONSUME_PURCHASE), this._platformSdk.payments.consumePurchaseAsync(this._paymentsPurchases[r].purchaseToken).then((function(e) {
                        t._paymentsPurchases.splice(r, 1), t._resolvePromiseDecorator(f.CONSUME_PURCHASE, e)
                    })).catch((function(e) {
                        t._rejectPromiseDecorator(f.CONSUME_PURCHASE, e)
                    }))), n.promise
                ...
                value: function() {
                    ...
                    return r || (r = this._createPromiseDecorator(f.GET_CATALOG), this._platformSdk.payments.getCatalogAsync().then((function(r) {
                        var n = t.map((function(e) {
                ...
                value: function() {
                    ...
                    if (!er(t.image)) return Promise.reject(new Error("Image is not base64"));
                    var r = this._getPromiseDecorator(f.INVITE_FRIENDS);
                    return r || (r = this._createPromiseDecorator(f.INVITE_FRIENDS), this._platformSdk.inviteAsync(t).then((function() {
                ...
                value: function(e) {
                    ...
                    if (!er(e.image)) return Promise.reject(new Error("Image is not base64"));
                    var r = this._getPromiseDecorator(f.SHARE);
                    return r || (r = this._createPromiseDecorator(f.SHARE), this._platformSdk.shareAsync(e).then((function() {
                        t._resolvePromiseDecorator(f.SHARE)
                    })).catch((function(e) {
                        t._rejectPromiseDecorator(f.SHARE, e)
                    }))), r.promise
                }
            }], n && Ea(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), y
        }(Xt);
        ...
        var Ha, Ua = function() {
            ...
            }], r && Ma(t.prototype, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), e
        }();
        ...
        var ns = "banner",
            ...
            ms = function(r) {
                ...
                function y() {
                    ...
                    for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                    return Ka(Za(e = d.call.apply(d, [this].concat(r))), hs), Ka(Za(e), ys), $a(Za(e), ps, {
                        get: vs,
                        set: void 0
                    }), $a(Za(e), ds, {
                        writable: !0,
                ...
                return n = y, (o = [{
                    ...
                    value: function() {
                        ...
                        return r || (r = this._createPromiseDecorator(f.INITIALIZE), this._defaultStorageType = u.PLATFORM_INTERNAL, ts(this, ds).addListener((function(r) {
                            var n = r.data;
                            if (null != n && n.type && n.type === t.PLATFORM && (n.action === f.INITIALIZE && rs(e, ys, _s).call(e, n), n.action === cs)) {
                                var o, i = ts(e, ds).generateMessageId(),
                                    a = (null == n || null === (o = n.options) || void 0 === o ? void 0 : o.resources) || [];
                        ...
                        if (!n) {
                            ...
                            ts(this, ds).addListener((function e(n) {
                                ...
                                if ((null == i ? void 0 : i.type) === t.PLAYER && i.action === f.AUTHORIZE_PLAYER && i.id === o) {
                                    var a = i.player,
                                        s = i.auth;
                                    "success" === s.status ? (r._isPlayerAuthorized = !0, r._playerId = a.userId, r._playerName = a.name, a.profilePictureUrl && (r._playerPhotos = [a.profilePictureUrl]), r._resolvePromiseDecorator(f.AUTHORIZE_PLAYER)) : r._rejectPromiseDecorator(f.AUTHORIZE_PLAYER, s.error), ts(r, ds).removeListener(e)
                                }
                            })), ts(this, ds).send({
                                type: t.PLAYER,
                            ...
                            var o, i = ts(e, ds).generateMessageId(),
                                a = function a(s) {
                                    ...
                                    if ((null == u ? void 0 : u.type) === t.PLATFORM && u.action === is && u.id === i) {
                                        if (!u.time) return void n(new Error("Invalid server time"));
                                        clearTimeout(o), r(u.time), ts(e, ds).removeListener(a)
                                    }
                                };
                    ...
                    value: function() {
                        ...
                        ts(this, ds).addListener((function r(n) {
                            var o = n.data;
                            if ((null == o ? void 0 : o.type) === t.ADVERTISEMENT) switch (o.payload.status) {
                                case "start":
                                ...
                                case "failed":
                                    ...
                                    break;
                                case "close":
                                    e._setInterstitialState(i.CLOSED), ts(e, ds).removeListener(r)
                            }
                        })), ts(this, ds).send({
                        ...
                        ts(this, ds).addListener((function r(n) {
                            ...
                            if ((null == o ? void 0 : o.type) === t.ADVERTISEMENT) switch (o.payload.status) {
                                ...
                                case "rewarded":
                                    ...
                                    break;
                                case "close":
                                    e._setRewardedState(a.CLOSED), ts(e, ds).removeListener(r)
                            }
                        })), ts(this, ds).send({
                            type: t.ADVERTISEMENT,
                            action: "reward"
                    ...
                    value: function() {
                        ...
                        return e || (e = this._createPromiseDecorator(f.INVITE_FRIENDS), this._resolvePromiseDecorator(f.INVITE_FRIENDS), ts(this, ds).send({
                            type: t.SOCIAL,
                    ...
                    value: function() {
                        ...
                        return e || (e = this._createPromiseDecorator(f.JOIN_COMMUNITY), this._resolvePromiseDecorator(f.JOIN_COMMUNITY), ts(this, ds).send({
                            type: t.SOCIAL,
                    ...
                    value: function() {
                        ...
                        return e || (e = this._createPromiseDecorator(f.SHARE), this._resolvePromiseDecorator(f.SHARE), ts(this, ds).send({
                            type: t.SOCIAL,
                            action: f.SHARE
                        })), e.promise
                    }
                    ...
                    value: function() {
                        ...
                        return e || (e = this._createPromiseDecorator(f.CREATE_POST), this._resolvePromiseDecorator(f.CREATE_POST), ts(this, ds).send({
                            type: t.SOCIAL,
                    ...
                    value: function() {
                        ...
                        return e || (e = this._createPromiseDecorator(f.ADD_TO_HOME_SCREEN), this._resolvePromiseDecorator(f.ADD_TO_HOME_SCREEN), ts(this, ds).send({
                            type: t.SOCIAL,
                    ...
                    value: function() {
                        ...
                        return e || (e = this._createPromiseDecorator(f.ADD_TO_FAVORITES), this._resolvePromiseDecorator(f.ADD_TO_FAVORITES), ts(this, ds).send({
                            type: t.SOCIAL,
                    ...
                    value: function() {
                        var e = this._getPromiseDecorator(f.RATE);
                        return e || (e = this._createPromiseDecorator(f.RATE), this._resolvePromiseDecorator(f.RATE), ts(this, ds).send({
                            type: t.SOCIAL,
                            action: f.RATE
                        })), e.promise
                    }
                        ...
                        if (!o) {
                            ...
                            ts(this, ds).addListener((function n(o) {
                                ...
                                if ((null == a ? void 0 : a.type) === t.PAYMENTS && a.action === f.PURCHASE && a.id === i) {
                                    var s;
                                    if (!a.purchase || "object" !== Wa(a.purchase)) return r._rejectPromiseDecorator(f.PURCHASE, new Error("Invalid purchase")), void ts(r, ds).removeListener(n);
                                    if (null !== (s = a.purchase) && void 0 !== s && s.status) {
                                        var u = xa({
                                            commonId: e
                                        }, a.purchase.purchaseData);
                                        r._paymentsPurchases.push(u), r._resolvePromiseDecorator(f.PURCHASE, u)
                                    } else {
                                        var c;
                        ...
                        if (!o) {
                            ...
                            ts(this, ds).addListener((function e(o) {
                                ...
                                if ((null == a ? void 0 : a.type) === t.PAYMENTS && a.action === f.CONSUME_PURCHASE && a.id === i) {
                                    var s, u;
                                    if (!a.purchase || "object" !== Wa(a.purchase)) return r._rejectPromiseDecorator(f.CONSUME_PURCHASE, new Error("Invalid purchase")), void ts(r, ds).removeListener(e);
                                    null !== (s = a.purchase) && void 0 !== s && s.status ? (r._paymentsPurchases.splice(n, 1), r._resolvePromiseDecorator(f.CONSUME_PURCHASE, a.result)) : r._rejectPromiseDecorator(f.CONSUME_PURCHASE, (null === (u = a.purchase) || void 0 === u ? void 0 : u.error) || new Error("Unknown consume purchase error")), ts(r, ds).removeListener(e)
                                }
                            })), ts(this, ds).send({
                                type: t.PAYMENTS,
                    ...
                    value: function() {
                        ...
                        if (!r) {
                            ...
                            ts(this, ds).addListener((function r(o) {
                                var i = o.data;
                                (null == i ? void 0 : i.type) === t.REMOTE_CONFIG && i.action === f.GET_REMOTE_CONFIG && i.id === n && (e._resolvePromiseDecorator(f.GET_REMOTE_CONFIG, i.result), ts(e, ds).removeListener(r))
                            })), ts(this, ds).send({
                    ...
                    value: function(e) {
                        ...
                        if (!n) {
                            ...
                            ts(this, ds).addListener((function e(n) {
                                var i = n.data;
                                (null == i ? void 0 : i.type) === t.CLIPBOARD && i.action === f.CLIPBOARD_WRITE && i.id === o && (r._resolvePromiseDecorator(f.CLIPBOARD_WRITE, !0), ts(r, ds).removeListener(e))
                            })), ts(this, ds).send({
                                type: t.CLIPBOARD,
                        ...
                        if (!r) {
                            ...
                            ts(this, ds).addListener((function r(o) {
                                ...
                                if ((null == i ? void 0 : i.type) === t.CLIPBOARD && i.action === as && i.id === n) {
                                    var a = i.text;
                                    e._resolvePromiseDecorator(as, a), ts(e, ds).removeListener(r)
                                }
                            })), ts(this, ds).send({
                                type: t.CLIPBOARD,
                                action: as,
                    ...
                    value: function(e) {
                        ...
                        if (!r) {
                            r = this._createPromiseDecorator(f.SET_LEADERBOARD_SCORE);
                            var n = xa({}, e);
                            "string" == typeof n.score && (n.score = parseInt(n.score, 10)), ts(this, ds).send({
                                type: t.LEADERBOARD,
                    ...
                    value: function(e) {
                        ...
                        if (!a) {
                            ...
                            ts(this, ds).addListener((function e(n) {
                                var a = n.data;
                                (null == a ? void 0 : a.type) === t.LEADERBOARD && a.action === f.GET_LEADERBOARD_SCORE && a.id === s && a.leaderboardName === o && (r._resolvePromiseDecorator(i, a.score), ts(r, ds).removeListener(e))
                            })), ts(this, ds).send({
                                type: t.LEADERBOARD,
                    ...
                    value: function(e) {
                        ...
                        if (!n) {
                            ...
                            ts(this, ds).addListener((function e(n) {
                                var i;
                                (null === (i = n.data) || void 0 === i ? void 0 : i.type) === t.LEADERBOARD && n.data.action === f.GET_LEADERBOARD_ENTRIES && n.data.id === o && (r._resolvePromiseDecorator(f.GET_LEADERBOARD_ENTRIES, n.data.entries), ts(r, ds).removeListener(e))
                            })), ts(this, ds).send({
                                type: t.LEADERBOARD,
                    ...
                    value: function(e) {
                        ...
                        return r || (r = this._createPromiseDecorator(f.SHOW_LEADERBOARD_NATIVE_POPUP), ts(this, ds).send({
                            type: t.LEADERBOARD,
                    ...
                    value: function(e) {
                        ...
                        return new Promise((function(n) {
                            ...
                            ts(r, ds).addListener((function e(i) {
                                var a = i.data;
                                (null == a ? void 0 : a.type) === t.ACHIEVEMENTS && a.action === ss && a.id === o && (n(a.result), ts(r, ds).removeListener(e))
                            })), ts(r, ds).send({
                                type: t.ACHIEVEMENTS,
                                action: ss,
                                id: o,
                    ...
                    value: function(e) {
                        ...
                        return new Promise((function(n) {
                            ...
                            ts(r, ds).addListener((function e(i) {
                                var a = i.data;
                                (null == a ? void 0 : a.type) === t.ACHIEVEMENTS && a.action === us && a.id === o && (n(a.result), ts(r, ds).removeListener(e))
                            })), ts(r, ds).send({
                                type: t.ACHIEVEMENTS,
                                action: us,
                                id: o,
                ...
                }]) && Va(n.prototype, o), Object.defineProperty(n, "prototype", {
                    writable: !1
                }), y
            }(Xt);
        ...
        const Ds = function(t) {
            ...
            return r = c, (n = [{
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://game-cdn.poki.com/scripts/v2/poki-sdk.js").then((function() {
            ...
            }]) && Ps(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), c
        }(Xt);
        ...
        const Zs = function(t) {
            ...
            function l() {
                ...
                for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                return Cs(js(e = c.call.apply(c, [this].concat(r))), zs), Cs(js(e), Us), Cs(js(e), Hs), Cs(js(e), Fs), Bs(js(e), "_preloadedInterstitialPromise", null), Bs(js(e), "_preloadedRewardedPromise", null), e
            }
            return r = l, n = [{
                key: "platformId",
                get: function() {
                ...
                value: function() {
                    ...
                    if (this._isInitialized) return Promise.resolve();
                    var t = this._getPromiseDecorator(f.INITIALIZE);
                    return t || (t = this._createPromiseDecorator(f.INITIALIZE), Qt("https://assets.msn.com/staticsb/statics/latest/msstart-games-sdk/msstart-v1.0.0-rc.20.min.js").then((function() {
                ...
                value: function(e) {
                    ...
                    if (!r) return Promise.reject();
                    var n = this._getPromiseDecorator(f.PURCHASE);
                    return n || (n = this._createPromiseDecorator(f.PURCHASE), this._platformSdk.iap.purchaseAsync(r).then((function(r) {
                ...
                value: function(e) {
                    ...
                    if (r < 0) return Promise.reject();
                    var n = this._getPromiseDecorator(f.CONSUME_PURCHASE);
                    return n || (n = this._createPromiseDecorator(f.CONSUME_PURCHASE), this._platformSdk.iap.consumeAsync(this._paymentsPurchases[r].productId).then((function(e) {
                        "IAP_CONSUME_FAILURE" !== e.code ? (t._paymentsPurchases.splice(r, 1), t._resolvePromiseDecorator(f.CONSUME_PURCHASE, Rs(Rs({}, e.consumptionReceipt), {}, {
                ...
                value: function() {
                    ...
                    if (!t) return Promise.reject();
                    var r = this._getPromiseDecorator(f.GET_CATALOG);
                    return r || (r = this._createPromiseDecorator(f.GET_CATALOG), this._platformSdk.iap.getAllAddOnsAsync().then((function(r) {
                ...
                value: function() {
                    var e = this,
                        t = this._getPromiseDecorator(f.GET_PURCHASES);
                    return t || (t = this._createPromiseDecorator(f.GET_PURCHASES), this._platformSdk.iap.getPurchasesAsync().then((function(t) {
            ...
            }], n && Ts(r.prototype, n), Object.defineProperty(r, "prototype", {
                writable: !1
            }), l
        }(Xt);
        ...
        function qs(e) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                t % 2 ? Js(Object(r), !0).forEach((function(t) {
                    var n, o, i;
                    n = e, o = t, i = r[t], (o = Qs(o)) in n ? Object.defineProperty(n, o, {
                        value: i,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        function du() {
            ...
            if (this._options.forciblySetPlatformId) r = nu(this, fu, yu).call(this, this._options.forciblySetPlatformId.toLowerCase());
            else {
        ...
        const mu = function() {
            ...
            return f = r, (p = [{
                ...
                value: function(e) {
                    var r = this;
                    if (ou(this, au)) return Promise.resolve();
                    if (!ou(this, su)) {
                        ru(this, su, new R);
                        var n = "./playgama-bridge-config.json";
                        e && e.configFilePath && (n = e.configFilePath), fetch(n).then((function(e) {
                            return e.json()
                        })).then((function(e) {
                            r._options = qs({}, e)
                        })).catch((function() {
            ...
            }]) && Xs(f.prototype, p), Object.defineProperty(f, "prototype", {
                writable: !1
            }), r
        }();
